...
const IMAGES = {
  ...
  bangkok: "https://d2xsxph8kpxj0f.cloudfront.net/310419663029898140/7JGRSFRRiiGdqokZA4QqP6/gallery-bangkok-F4uZQ3cErpHEW8SdNspf36.webp",
          ...
          >
            <motion.div variants={fadeInUp}>
              <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer">
                <Card className="glass-card hover:border-green-500/40 transition-all duration-300 group h-full">
                  <CardContent className="p-6 text-center">
                    <div className="w-16 h-16 rounded-2xl bg-green-500/10 flex items-center justify-center text-green-500 mx-auto mb-4 group-hover:bg-green-500/20 transition-colors">
                      <MessageCircle className="w-8 h-8" />
                    </div>
                    <h3 className="font-serif text-lg font-semibold mb-2 text-foreground">{t.contact.whatsapp}</h3>
            ...
            <motion.div variants={fadeInUp}>
              <a href={LINE_URL} target="_blank" rel="noopener noreferrer">
                <Card className="glass-card hover:border-green-400/40 transition-all duration-300 group h-full">
                  <CardContent className="p-6 text-center">
                    <div className="w-16 h-16 rounded-2xl bg-green-400/10 flex items-center justify-center mx-auto mb-4 group-hover:bg-green-400/20 transition-colors">
                    ...
                    <h3 className="font-serif text-lg font-semibold mb-2 text-foreground">{t.contact.line}</h3>
              ...
              <a href={`tel:${PHONE.replace(/\s/g, "")}`}>
                <Card className="glass-card hover:border-primary/40 transition-all duration-300 group h-full">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="font-serif text-lg font-semibold mb-2 text-foreground">{t.contact.phone}</h3>
                    <p className="text-sm text-muted-foreground">{PHONE}</p>
                  </CardContent>
                </Card>
              </a>
